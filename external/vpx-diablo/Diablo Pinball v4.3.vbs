...
Sub EndOfBall()
    ...
    If NOT Tilted Then
        ...
        DMD "bonus-background_Video.gif", "MONSTERS KILLED", monsters(CurrentPlayer), 700
        vpmtimer.addtimer 4400, "PlaySound ""bonus"", 0, 1, 0, 0, 4000, 0, 0 '"

        'Player Level
        AwardPoints = Level(CurrentPlayer) * 50000
        TotalBonus = TotalBonus + AwardPoints
        DMD "bonus-background_Video.gif", "LEVEL BONUS", Level(CurrentPlayer), 700
        ...
        DMD "bonus-background_Video.gif", "TOTAL BONUS X " &BonusMultiplier(CurrentPlayer), TotalBonus, 2200
    ...
    If(bGameInPLay = True)AND(Tilted = False)Then
        ...
        Else
            ...
            If(BallsOnPlayfield = 0)Then
                ...
                Select Case Mode(0)
                    Case 0, 1, 3, 5, 7
                        DMD "ball-lost-2_Video.gif", "", "", 5000
                        vpmtimer.addtimer 4500, "EndOfBall '"
                    Case 2, 4, 6, 8, 10
                        DMD "ball-lost-1_Video.gif", "", "", 10000
...
Sub AwardSkillshot()
    ...
    Select case SkillShotValue(CurrentPlayer)
        case 1000000
            DMD "skillshot1_Video.gif", " ", " ", 5000
            AddScore SkillshotValue(CurrentPLayer)
        case 2000000
            DMD "skillshot2_Video.gif", " ", " ", 5000
            AddScore SkillshotValue(CurrentPLayer)
        case 3000000
            DMD "skillshot3_Video.gif", " ", " ", 5000
            AddScore SkillshotValue(CurrentPLayer)
        case 4000000
            DMD "skillshot4_Video.gif", " ", " ", 5000
            AddScore SkillshotValue(CurrentPLayer)
        case 5000000
            DMD "skillshot5_Video.gif", " ", " ", 5000
            AddScore SkillshotValue(CurrentPLayer)
        case ELSE
            DMD "skillshot_Video.gif", " ", " ", 5000
            AddScore SkillshotValue(CurrentPLayer)
    End Select
...
Sub ShowTableInfo
    ...
    If bFreePlay Then
        ...
        DMD "intro-freeplay_Video.gif", "", "", 63000
    ...
    Else
        ...
        End If
        DMD "intro-coins_Video.gif", "", "", 65000
    End If
...
Sub CheckQUESTLanes() 'use the lane lights
    If l15.State + l16.State + l17.State + l18.State + l19.State = 5 Then
        DMD "quest-lights_Video.gif", "", "", 4000
        'Increase bonus multiplier
        AddBonusMultiplier 1
        'flash and Light effect
        l15.State = 0
...
Sub CheckBASHTargets
    If l28.State + l29.State + l30.State + l31.State = 4 Then
        ...
        Select Case Mode(0)
            Case 1, 3, 5, 7, 9
                DMD "bash-lights_Video.gif", "", "", 4000
...
Sub CheckSKILLTargets
    If l35.State + l36.State + l37.State + l40.State + l41.State = 5 Then
        ...
        Select Case Mode(0)
            Case 1, 3, 5, 7, 9
                DMD "skill-lights_Video.gif", "", "", 3000
...
Sub WinAct1
    ...
    'play a sound - video -dmd
    StopSound Song:Song = ""
    DMD "act-complete_Video.gif", "", "", 12000
    FlashEffect 2
    DOF 154, DOFPulse
    'setup variables
    Mode(0) = 0
...
Sub StartButcher
    StopSound Song:Song = ""
    DMD "butcher-start_Video.gif", "", "", 12000
    ' start music after the intro
...
Sub WinButcher
    'play a sound - video -dmd
    StopSound Song:Song = ""
    DMD "butcher-defeated_Video.gif", "", "", 14000
    FlashEffect 2
    DOF 154, DOFPulse
    LightEffect 2
    GiEffect 2
...
Sub StartBelial
    StopSound Song:Song = ""
    DMD "belial-start_Video.gif", "", "", 12000
    ' start music after the intro
    vpmtimer.AddTimer 12000, "PlaySong ""mu_lordfight"" '"
    vpmtimer.AddTimer 8000, "PlaySound ""battle"" '"
    LordStrength = 100
...
Sub WinBelial
    'play a sound - video -dmd
    StopSound Song:Song = ""
    DMD "belial-defeated_Video.gif", "", "", 14000
    FlashEffect 2
    DOF 154, DOFPulse
    LightEffect 2
    GiEffect 2
...
Sub StartAzmodan
    StopSound Song:Song = ""
    DMD "azmodan-start_Video.gif", "", "", 20000
    ' start music after the intro
...
Sub WinAzmodan
    'play a sound - video -dmd
    StopSound Song:Song = ""
    DMD "azmodan-defeated_Video.gif", "", "", 14000
    FlashEffect 2
    DOF 154, DOFPulse
    LightEffect 2
    GiEffect 2
...
Sub StartDiablo
    StopSound Song:Song = ""
    DMD "diablo-start_Video.gif", "", "", 19000
    ' start music after the intro
...
Sub WinDiablo
    'play a sound - video -dmd
    StopSound Song:Song = ""
    DMD "diablo-defeated_Video.gif", "", "", 14000
    FlashEffect 2
    DOF 154, DOFPulse
    LightEffect 2
    GiEffect 2
...
Sub StartMalthael
    StopSound Song:Song = ""
    DMD "malthael-start_Video.gif", "", "", 18000
    ' start music after the intro
...
Sub WinMalthael2
    ...
    'play a sound - video -dmd
    StopSound Song:Song = ""
    DMD "malthael-defeated_Video.gif", "", "", 80000
    'light show
    LightSeqFlasher.UpdateInterval = 150
