...
cPuPPack = "killershof"    ' name of the PuP-Pack / PuPVideos folder for this table
...
Const cGameName = "killershof"
Const TableName = "KillersHOF"
...
Sub Table1_KeyUp(ByVal keycode)
    ...
    If keycode = PlungerKey Then
        ...
        If bBallInPlungerLane Then PlaySoundAt "fx_Bell", plunger
    End If
...
Sub InstantInfo
    ...
    DMD CL("WEAPONS FOUND"), CL(MonstersKilled(CurrentPlayer)), "", eNone, eNone, eNone, 800, False, ""
...
Sub PlayMultiballSong 'mu_war songs
    Dim tmp
    tmp = INT(RND * 4)
    Select Case tmp
        Case 0:PlaySong ""
    ...
    Else
        Select Case Battle(CurrentPlayer, 0)
            Case 0
                PlaySong "mu_main"
            Case 1
                PlaySong "ChuckyTheme"
            Case 2
                PlaySong "MyersTheme"
            Case 3
                Playsong "LecterTheme"
            Case 4
                Playsong "TorrenceTheme"
            Case 5
                Playsong "LeatherfaceTheme"
            Case 6
                Playsong "GhostfaceTheme"
            Case 7
                Playsong "PennywiseTheme"
            Case 8
                Playsong "JigsawTheme"
            Case 9
                Playsong "JasonTheme"
            Case 10
                Playsong "KrugerTheme"
            Case 11
                Playsong "PinheadTheme"
            Case 12
                Playsong "BatesTheme"
            Case 13
                PlayMultiballSong
...
'Lane Bonus
        ...
        TotalBonus = TotalBonus + AwardPoints
        DMD CL(FormatScore(AwardPoints)), CL("WEAPONS FOUND " & MonstersKilled(CurrentPlayer)), "", eBlink, eNone, eNone, 800, False, ""
...
Sub EndOfGame()
    ...
    'vpmTimer.addTimer 9000, "pupevent 501 '"
            'pupevent 501
...
Sub swPlungerRest_Hit()
    ...
    If bAutoPlunger Then
        ...
        PlungerIM.AutoFire
        DOF 121, DOFPulse
        PlaySoundAt "fx_Bell", swPlungerRest
        bAutoPlunger = False
    End If
...
Sub ShowTableInfo
    ...
    Else
        ...
        End If
    End If
    DMD "       CAPNCLAW", "          PRESENTS", "d_ccpresents", eNone, eNone, eNone, 3000, False, ""
    DMD "       WITH THANKS", "         TO JPSALAS", "d_jppresents", eNone, eNone, eNone, 3000, False, ""
...
Sub Check6BankTargets
    ...
    If light23.state + light24.state + light25.state + light26.state + light27.state + light28.state = 6 Then
        ...
        DMD " YOU FOUND", "  A WEAPON", "monster_" &tmp, eNone, eNone, eNone, 2500, True, ""
        LightEffect 1
        FlashEffect 1
        ...
        Else
            Light38.State = 1
            AddScore 25000
        vpmTimer.addTimer 3000, "pupevent 574 '"
            pupevent 574
        End If
        ' reset the lights
        light23.state = 0
...
Sub GiveRandomAward() 'from the Jackal Sphynx
    ...
    DMD CL("WEAPON AWARD"), "", "", eNone, eNone, eNone, 50, False, "fx_spinner"
    ...
    Select Case tmp
        Case 1, 2, 3, 4, 5, 6 'Lit Extra Ball
            DMD "", CL("EXTRA BALL"), "", eNone, eBlink, eNone, 1500, True, "fx_fanfare1"
            light39.State = 2
            pupevent 575
...
Sub StartBattle
    ...
    Select Case NewBattle
        Case 1 'Bast = Super Spinners
            DMD CL("DEFEAT CHUCKY"), CL("SHOOT THE SPINNERS"), "", eNone, eNone, eNone, 1500, True, ""
            Light33.State = 2
            Light35.State = 2
            SpinCount = 0
            'Playsound "ChuckyStartBattle"
            pupevent 530
            vpmTimer.addTimer 7000, "pupevent 531 '"
            pupevent 531
        Case 2 'Isis = Super Pop Bumpers
            DMD CL("DEFEAT MICHAEL MYERS"), CL("HIT THE POP BUMPERS"), "", eNone, eNone, eNone, 1500, True, ""
            Light55.State = 2
            LightSeqBumpers.Play SeqRandom, 10, , 1000
            SuperBumperHits = 0
            'Playsound "MyersStartBattle"
            pupevent 535
            vpmTimer.addTimer 6000, "pupevent 536 '"
            pupevent 536
        Case 3 'Amon = Ramps
            DMD CL("DEFEAT LECTER"), CL("SHOOT THE RAMPS"), "", eNone, eNone, eNone, 1500, True, ""
            Light36.State = 2
            Light34.State = 2
            RampHits3 = 0
            'Playsound "LecterStartBattle"
            pupevent 537
            vpmTimer.addTimer 4000, "pupevent 538 '"
            pupevent 538
        Case 4 'Shu = Orbits
            DMD CL("DEFEAT JACK TORRENCE"), CL("SHOOT THE ORBITS"), "", eNone, eNone, eNone, 1500, True, ""
            Light33.State = 2
            Light35.State = 2
            OrbitHits = 0
            'Playsound "TorrenceStartBattle"
            pupevent 533
            vpmTimer.addTimer 4000, "pupevent 534 '"
            pupevent 534
        Case 5 'Set = Shoot the lights 2
            DMD CL("DEFEAT LEATHERFACE"), CL("SHOOT THE LIGHTS"), "", eNone, eNone, eNone, 1500, True, ""
            Light29.State = 2
            Light30.State = 2
            Light31.State = 2
            Light32.State = 2
            ...
            Light36.State = 2
            Light37.State = 2
            'Playsound "LeatherfaceStartBattle"
            pupevent 539
            vpmTimer.addTimer 5000, "pupevent 540 '"
            pupevent 540
        Case 6 'Nepthys= Shoot the lights 1
            DMD CL("DEFEAT GHOSTFACE"), CL("SHOOT THE LIGHTS"), "", eNone, eNone, eNone, 1500, True, ""
            Light30.State = 2
            'Playsound "GhostfaceStartBattle"
            pupevent 541
            vpmTimer.addTimer 4000, "pupevent 542 '"
            pupevent 542
        Case 7 'Bes =  Blue Target Frenzy
            DMD CL("DEFEAT PENNYWISE"), CL("SHOOT THE TARGETS"), "", eNone, eNone, eNone, 1500, True, ""
            LightSeqBlueTargets.Play SeqRandom, 10, , 1000
            TargetHits7 = 0
            'Playsound "PennywiseStartBattle"
            pupevent 543
            vpmTimer.addTimer 5000, "pupevent 544 '"
            pupevent 544
        Case 8 'Serget = Left & Right Targets
            DMD CL("DEFEAT JIGSAW"), CL("SHOOT THE TARGETS"), "", eNone, eNone, eNone, 1500, True, ""
            Light31.State = 2
            Light29.State = 2
            TargetHits8 = 0
            'Playsound "JigsawStartBattle"
            pupevent 545
            vpmTimer.addTimer 5000, "pupevent 546 '"
            pupevent 546
        Case 9 'Anubis = Follow the Lights 1
            DMD CL("DEFEAT JASON VOORHES"), CL("SHOOT LIT LIGHTS"), "", eNone, eNone, eNone, 1500, True, ""
            FollowTheLights.Enabled = 1
            LightHits9 = 0
            'Playsound "JasonStartBattle"
            pupevent 547
            vpmTimer.addTimer 6000, "pupevent 548 '"
            pupevent 548
        Case 10 'Osiris = Super Loops
            DMD CL("DEFEAT FREDDY KRUGER"), CL("SHOOT THE LOOPS"), "", eNone, eNone, eNone, 1500, True, ""
            Light33.State = 2
            Light35.State = 2
            Gate2.Open = 1
            Gate3.Open = 1
            loopCount = 0
            'Playsound "KrugerStartBattle"
            pupevent 549
            vpmTimer.addTimer 6000, "pupevent 550 '"
            pupevent 550
        Case 11 'Horus = Follow the Lights 2
            DMD CL("DEFEAT PINHEAD"), CL("SHOOT LIT LIGHTS"), "", eNone, eNone, eNone, 1500, True, ""
            FollowTheLights.Enabled = 1
            LightHits11 = 0
            'Playsound "PinheadStartBattle"
            pupevent 551
            vpmTimer.addTimer 6000, "pupevent 552 '"
            pupevent 552
        Case 12 'Ra = Ramps and Orbits
            'uses the ramphits12 to count the hits
            DMD CL("DEFEAT NORMAN BATES"), CL("SHOOT RAMPS ORBITS"), "", eNone, eNone, eNone, 1500, True, ""
            Light36.State = 2
            Light34.State = 2
            RampHits12 = 0
            'Playsound "BatesStartBattle"
            pupevent 553
            vpmTimer.addTimer 5000, "pupevent 554 '"
            pupevent 554
        Case 13 'Mordekai the Summoner - the final battle
            DMD CL("KILLERMANIA"), CL("SHOOT THE JACKPOTS"), "", eNone, eNone, eNone, 1500, True, ""
            AddMultiball 4
            StartJackpots
            ChangeGi 5
            vpmTimer.addTimer 500, "pupevent 567 '"
            pupevent 567
    End Select
End Sub
...
Sub WinBattle
    ...
    LightEffect 2
    GiEffect 2
    If NewBattle = 13 Then 
    DMD "", CL("KILLERMANIA COMPLETED"), "_", eNone, eBlinkFast, eNone, 1000, True, ""
    pupevent 569
Else
    If NewBattle = 1 Then pupevent 555
    If NewBattle = 2 Then pupevent 556
    If NewBattle = 3 Then pupevent 557
    If NewBattle = 4 Then pupevent 558
    If NewBattle = 5 Then pupevent 559
    If NewBattle = 6 Then pupevent 560
    If NewBattle = 7 Then pupevent 561
    If NewBattle = 8 Then pupevent 562
    If NewBattle = 9 Then pupevent 563
    If NewBattle = 10 Then pupevent 564
    If NewBattle = 11 Then pupevent 565
    If NewBattle = 12 Then pupevent 566
    DMD "", CL("KILLER DEFEATED"), "_", eNone, eBlinkFast, eNone, 1000, True, ""
End If
    DOF 139, DOFPulse
    tmp = INT(RND * 4)
    Select Case tmp
        Case 0:vpmtimer.addtimer 1500, "PlaySound ""vo_killer"" '"
        Case 1:vpmtimer.addtimer 1500, "PlaySound ""vo_sliced"" '"
        Case 2:vpmtimer.addtimer 1500, "PlaySound ""vo_slow"" '"
        Case 3:vpmtimer.addtimer 1500, "PlaySound ""vo_victory"" '"
    End Select
    StopBattle2
    NewBattle = 0
